...
int main(void)
{
  ...
  // leftstr[0] and leftstr[1], .. are pointers to char *
  // sizeof leftstr[0] = sizeof leftstr[1] = 4 bytes
  // sizeof leftstr = 12 bytes
  // to printf leftstr[0], use %s
  // leftstr[0][0] point to 'a', leftstr[0][1] point to 'b'
  // to print leftstr[0][0], use %c, not %s (format ‘%s’ expects argument of type ‘char *’)
